...
public class PlayerMovementAdvanced : MonoBehaviour
{
    ...
    private void StateHandler()
    {
        ...
        else if (wallrunning)
        {
            ...
            print("Walkrunning" + wallrunningleft);
            CharatereAnimator.Play("Walkrunning" + wallrunningleft);
        }
        ...
        // Mode - Walking
        else if (grounded && state == MovementState.walking)
        {
            state = MovementState.walking;
            desiredMoveSpeed = walkSpeed;
            CharatereAnimator.Play("Walk");
        }

        else if(grounded && state == MovementState.idle)
        {
            desiredMoveSpeed = 0;
            CharatereAnimator.Play("idl");
        }
